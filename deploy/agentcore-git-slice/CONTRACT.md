...
manifest result: repo, remote_url, base_sha, branch, model, allowed_paths, artifact_paths, active_stage, deadline, canary_secret_arn, canary_sha256.
...
Runtime output must never echo capability/credentials. A boot_id generated in the process differentiates recreated VMs.
